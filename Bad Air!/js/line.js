class Line {
  ...
  constructor(_config, _data, _yType) {
    this.config = {
  ...
  initVis() {
    ...
    vis.xValue = d => d.year; 
    console.log("initializing xAxis with year data");

    switch (vis.yType) {
      case "max": 
        console.log("Using AQI type: ", this.yType);
        vis.yValue = d => d.maxAQI;
        break;
      case "percentile":
        console.log("Using AQI type: ", this.yType);
        vis.yValue = d => d.percintileAQI;
        console.log(data.percintileAQI);
        break;
      case "median":
        console.log("Using AQI type: ", this.yType);
        vis.yValue = d => medianAQI
        break;
    }

    console.log("Y-values successfully set!");
